package com.aidcompass.appointment.user_appointment_date;

import com.aidcompass.appointment.UserAppointmentService;
import com.aidcompass.appointment.models.AppointmentRegistrationDto;
...
public class UniqueUserAppointmentDateValidator implements ConstraintValidator<UniqueUserAppointmentDate, AppointmentRegistrationDto> {
    ...
    public boolean isValid(AppointmentRegistrationDto appointmentRegistrationDto,
        ...
        UUID userId = appointmentRegistrationDto.getUserId();
