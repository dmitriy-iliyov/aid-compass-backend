...
public class ContactController {
    ...
    @PostMapping
    public ResponseEntity<PrivateContactResponseDto> create(@AuthenticationPrincipal PrincipalDetails principal,
    ...
    @PostMapping("/batch")
    public ResponseEntity<List<PrivateContactResponseDto>> batchCreate(@AuthenticationPrincipal PrincipalDetails principal,
                                                                       @RequestBody
    ...
    public ResponseEntity<?> requestConfirmation(@AuthenticationPrincipal PrincipalDetails principal,
    ...
    public ResponseEntity<?> linkEmailToAccount(@AuthenticationPrincipal PrincipalDetails principal,
    ...
    @GetMapping("/primary")
    public ResponseEntity<List<PublicContactResponseDto>> getPrimaryContacts(@AuthenticationPrincipal PrincipalDetails principal) {
        return ResponseEntity
    ...
    @GetMapping("/private")
    public ResponseEntity<List<PrivateContactResponseDto>> getPrivateContacts(@AuthenticationPrincipal PrincipalDetails principal) {
        return ResponseEntity
                .status(HttpStatus.OK)
    ...
    @PatchMapping
    public ResponseEntity<PrivateContactResponseDto> update(@AuthenticationPrincipal PrincipalDetails principal,
    ...
    @DeleteMapping
    public ResponseEntity<?> deleteAll(@AuthenticationPrincipal PrincipalDetails principal) {
