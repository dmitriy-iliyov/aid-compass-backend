...
public class ContactUpdateValidator implements ConstraintValidator<Contact, UpdateDto> {

    private final FormatValidator validator;


    @Override
    public boolean isValid(UpdateDto contactUpdateDto, ConstraintValidatorContext context) {
