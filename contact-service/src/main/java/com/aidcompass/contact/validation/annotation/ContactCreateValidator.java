...
public class ContactCreateValidator implements ConstraintValidator<Contact, CreateDto> {

    private final UniquenessValidatorImpl uniquenessValidator;
    private final FormatValidator formatValidator;


    @Override
    public boolean isValid(CreateDto contact, ConstraintValidatorContext context) {
