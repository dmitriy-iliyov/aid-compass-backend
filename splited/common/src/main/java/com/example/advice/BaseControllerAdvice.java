...
//    }
    ...
    public ResponseEntity<?> handleNotFoundException(NotFoundException e, Locale locale) {
    ...
    public ResponseEntity<?> handleIllegalStateException(InvalidInputException e, Locale locale){
        ProblemDetail problemDetail = ProblemDetail.forStatusAndDetail(HttpStatus.BAD_REQUEST,
                messageSource.getMessage("400", null, "error.400", locale));
        problemDetail.setProperty("properties", Map.of("errors", List.of(e.getErrorDto())));
        return ResponseEntity
