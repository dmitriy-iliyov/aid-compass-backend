...
@Service
public class TelegramConfirmationService implements ResourceConfirmationService {

    private final ResourceType type = ResourceType.TELEGRAM;
    ...
    private final String KEY_TEMPLATE = CONF_TOKEN_KEY_TEMPLATE + "tg:%s";
    private final ConfirmationRepository confirmationRepository;

    public TelegramConfirmationService(@Qualifier("telegramMessageService") MessageService messageService,
