...
import com.aidcompass.message.exceptions.MessageModuleControllerAdvice;
...
public class PasswordRecoveryControllerIntegrationTests {
    ...
    void recoverPassword_whenTokenInvalid_shouldReturnBadRequest() throws Exception {
        ...
        Mockito.doThrow(new InvalidPasswordRecoveryTokenException()).when(passwordRecoveryService).recoverPassword(token, password);
