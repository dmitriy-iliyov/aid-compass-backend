...
public class AuthorityServiceUnitTests {
    ...
    void findByAuthority_whenAuthorityNotExist_shouldThrowException() {
        Authority authority = Authority.ROLE_USER;
        doThrow(new AuthorityBaseNotFoundException()).when(authorityRepository).findByAuthority(any(Authority.class));

        assertThrows(AuthorityBaseNotFoundException.class, () -> authorityService.findByAuthority(authority));
    ...
    void toAuthorityEntityList_whenAuthorityNotFound_shouldThrowException() {
        ...
        assertThrows(AuthorityBaseNotFoundException.class,
