...
import com.example.exceptions.AuthModuleControllerAdvice;
import com.example.exceptions.illegal_input.IncorrectPasswordExceptionBase;
import com.example.exceptions.not_found.EmailBaseNotFoundException;
...
public class UserControllerIntegrationTests {
    ...
    void deleteUserByPassword_whenPassIncorrect_shouldReturn400() throws Exception {
        ...
        doThrow(new IncorrectPasswordExceptionBase()).when(userFacade).deleteByPassword(any(UUID.class), any(String.class));
    ...
    void confirmEmail_whenEmailNotExist_shouldReturn404() throws Exception {
        ...
        doNothing().when(userFacade).confirmByEmail(any(String.class));
        doThrow(new EmailBaseNotFoundException()).when(userFacade).existsByEmail(any(String.class));
