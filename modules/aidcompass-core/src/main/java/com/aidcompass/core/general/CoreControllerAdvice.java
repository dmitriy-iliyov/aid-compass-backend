...
@RestControllerAdvice(basePackages = {"com.aidcompass.core.contact", "com.aidcompass.core.general"})
public class CoreControllerAdvice extends BaseControllerAdvice {

    public CoreControllerAdvice(ExceptionMapper exceptionMapper, MessageSource messageSource) {
