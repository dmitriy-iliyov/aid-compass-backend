...
public class ContactControllerUnitTests {
    ...
    void createContacts_whenValidContactsList_shouldReturn201() throws IOException {
        ...
        ResponseEntity<List<PrivateContactResponseDto>> response = contactController.createContacts(ownerId, dtoList);
    ...
    void createContacts_whenFacadeThrows_shouldThrowException() throws IOException {
        ...
        assertThrows(RuntimeException.class, () -> contactController.createContacts(ownerId, dtoList));
        verify(contactFacade, times(1)).saveAll(ownerId, dtoList);
    }
    ...
    void updateAllContacts_whenValidContactsList_shouldReturn200WithUpdatedContacts() {
        ...
        ResponseEntity<List<PrivateContactResponseDto>> response = contactController.updateAllContacts(ownerId, updateDtoList);
    ...
    void updateAllContacts_whenEmptyList_shouldReturn200WithEmptyList() {
        UUID ownerId = UUID.randomUUID();
        List<ContactUpdateDto> emptyUpdateList = Collections.emptyList();
        List<PrivateContactResponseDto> emptyResponseList = Collections.emptyList();

        when(contactFacade.updateAll(ownerId, emptyUpdateList)).thenReturn(emptyResponseList);
        ...
        verify(contactFacade, times(1)).updateAll(ownerId, emptyUpdateList);
    }
    ...
    void updateAllContacts_whenFacadeThrows_shouldThrowException() {
        ...
        assertThrows(RuntimeException.class, () -> contactController.updateAllContacts(ownerId, updateDtoList));
        verify(contactFacade, times(1)).updateAll(ownerId, updateDtoList);
    }
